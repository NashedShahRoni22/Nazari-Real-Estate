  ...
  return (
    <section className="min-h-screen flex justify-center items-center bg-gray-200">
      ...
      >
        ...
        <Input variant="static" required type="email" name="email" label="Enter Email" />
        <Input variant="static" required type="password" name="password" label="Enter Password" />
        <Button type="submit" className="bg-primary" disabled={loader}>Log in</Button>
      </form>
    </section>
  );
}
