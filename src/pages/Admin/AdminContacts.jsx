...
export default function AdminContacts() {
  const url = `${import.meta.env.VITE_API_ROOT_URL}/contacts`;
  ...
  const TABLE_HEAD = ["Date", "User Name", "User Email", "User Phone", "User Address"];
  return (
    <div className="p-5 md:p-10">
      <h2 className="text-xl font-semibold">Contact request: {contacts?.length}</h2>
